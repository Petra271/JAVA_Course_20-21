...
/**
 * Iznimka koja signalizira da je korisnik probao napraviti nedozvoljeni unos u
 * kalkulator (primjerice, broj koji se unosi već ima decimalnu točku, a
 * korisnik je probao dodati još jednu).
 * 
 * @author marcupic
 */
