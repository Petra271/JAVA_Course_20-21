...
public class ArrayIndexedCollection implements List {
	 ...
	 *
	 */
	private static class IndexedArrayElementsGetter implements ElementsGetter {
		 ...
		 */
		public IndexedArrayElementsGetter(ArrayIndexedCollection array) {
			this.array = array;
	...
	public ElementsGetter createElementsGetter() {
		return new IndexedArrayElementsGetter(this);
	}
